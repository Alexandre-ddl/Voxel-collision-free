...
def collision_octree_non_dic(octree1,octree2, vect_translat_1  = np.array([0,0,0]) , vect_translat_2= np.array([0,0,0])):
    dic_octree1={}
    dic(octree1,dic_octree1)
    first_key_1 = next(iter(dic_octree1))
    
    dic_octree2={}
    dic(octree2,dic_octree2)
    first_key_2 = next(iter(dic_octree2))
    ...
    where_collision(first_key_1, first_key_2, dic_octree1, dic_octree2)            
